...
### API Structure
Refer to `CLAUDE.md` for a full overview of the repository structure, database access conventions, route registration patterns, etc. It's a configuration file that was generated by Claude Claude Code, an AI-powered coding assistant.
